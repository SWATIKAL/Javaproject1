...
public class String11_Concatanation {
	...
	public static void main (String[] args)
	    {
		String11_Concatanation m= new String11_Concatanation();
	      String str1 =  "hello";
		  String str2 =  "hi";
		  String str3 =  "aaa";
		  String str4 =  "bbb";
		  System.out.println("The given strings is: "+str1+" and "+str2);
		  System.out.println("The new string is: "+((String11_Concatanation) m).minCat(str1,str2));
		  System.out.println("The given strings is: "+str3+" and "+str4);
		  System.out.println("The new string is: "+((String11_Concatanation) m).minCat(str3,str4));
